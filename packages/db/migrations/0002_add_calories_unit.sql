...
INSERT INTO `__new_task`("id", "project_id", "user_id", "title", "target_value", "unit", "importance_weight", "sort_order", "scheduled_start", "scheduled_end", "created_at", "updated_at") SELECT "id", "project_id", "user_id", "title", "target_value", "unit", "importance_weight", "sort_order", "scheduled_start", "scheduled_end", "created_at", "updated_at" FROM `task`;--> statement-breakpoint
